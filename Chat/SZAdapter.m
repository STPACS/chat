...
CGFloat const SCREEN_WIDTH_XR = 414.f;
CGFloat const SCREEN_WIDTH_XSMax = 414.f;
...
CGFloat const SCREEN_HEIGHT_XR = 896.f;
CGFloat const SCREEN_HEIGHT_XSMax = 896.f;
