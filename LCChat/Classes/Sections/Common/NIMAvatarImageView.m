...
- (void)setAvatarBySession:(NIMSession *)session
{
    ...
    [self nim_setImageWithURL:[NSURL URLWithString:session.avatarURL] placeholderImage:info.avatarImage];
}
...
- (void)setImageWithUrlString:(NSString *)urlString placeholderImage:(UIImage *)placeholderImage options:(SDWebImageOptions)options {
    ...
    [self didSetImageUrl:[NSURL URLWithString:urlString] placeholderImage:placeholderImage options:options];
}
