...
{
    self.inputTextView.placeholderAttributedText = [[NSAttributedString alloc] initWithString:placeHolder?placeHolder:@"啦啦啦啦" attributes:@{NSForegroundColorAttributeName:[UIColor grayColor]}];
}
